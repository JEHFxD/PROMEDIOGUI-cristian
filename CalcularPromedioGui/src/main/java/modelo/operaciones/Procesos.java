...
public class Procesos {
    ...
    public boolean verificarValido(String nombre, String documento, double nota1, double nota2, double nota3) {
        ...
        if (nombre.length() < 1) {
            JOptionPane.showMessageDialog(null, "Se debe ingresar un nombre", "Datos invalidos", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        
        if (!(nota1 >= 0 && nota1 <= 5)) {
            JOptionPane.showMessageDialog(null, "La nota 1 debe estar en el rango de 0 a 5", "Datos invalidos", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        
        if (!(nota2 >= 0 && nota2 <= 5)) {
            JOptionPane.showMessageDialog(null, "La nota 2 debe estar en el rango de 0 a 5", "Datos invalidos", JOptionPane.ERROR_MESSAGE);
            return false;
        }
        
        if (!(nota3 >= 0 && nota3 <= 5)) {
            JOptionPane.showMessageDialog(null, "La nota 3 debe estar en el rango de 0 a 5", "Datos invalidos", JOptionPane.ERROR_MESSAGE);
            return false;
        }
